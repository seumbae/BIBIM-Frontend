  ...
  return (
    <div>
      <div className={styles.create}>
        <input className={styles.inputProjectName} id="projectName" type="text" onChange={onHandleChange} name="projectName" placeholder="Project Name" required/>
        <input className={styles.inputUrl} id="repoUrl" type="text" onChange={onHandleChange} name="repoUrl" placeholder="Repository URL" required/>
