		...
		<Routes>
			...
			<Route element={<PrivateRoutes />}>
				...
				<Route element={<DetailLayout />}>
					<Route
						path="/dev/:projectTitle/status"
						element={<DetailStatusPage />}
					/>
					<Route
						path="/dev/:projectTitle/profile"
						element={<ProjectProfile />}
					/>
					<Route path="/dev/:projectTitle/issues" element={<ProjectIssuse />} />
					<Route
						path="/dev/:projectTitle/history"
						element={<ProejctHistory />}
					/>
					<Route
						path="/dev/:projectTitle/configuration"
